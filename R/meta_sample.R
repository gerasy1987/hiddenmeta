...
#' @param force_samples named list of length two giving the sample and estimator identifiers that are forced to be sampled across studies
#' @param force_estimators named list of length two giving the sample and estimator identifiers that are forced to be sampled across studies
#'
...
get_meta_sample <-
  function(data, drop_nonsampled = FALSE,
    ...
    data <-
      ...
      dplyr::mutate(
        selected_samples =
          list(force_sample[[sample(1:length(force_sample), size = 1)]]),
        selected_sample =
