...
#' @param sampling_args named list of named lists of arguments to sampling function (the set of arguments can be excessive)
#' @param sampling_strategy character string giving name of the sampling strategy handler. Currently supports only \code{"sample_rds"}, \code{"sample_pps"}, or \code{"sample_tls"}
#'
...
get_meta_sample <- function(data,
                            sampling_variable,
                            drop_nonsampled = FALSE,
                            sampling_args,
                            sampling_strategy = c("sample_rds", "sample_pps", "sample_tls")
) {
