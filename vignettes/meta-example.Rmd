...
cl <- parallel::makeCluster(50) #Change based on # of cores in computer
doParallel::registerDoParallel(cl)

# Export everything needed
parallel::clusterExport(cl, c("meta_study", "sim_pop", "sim_meta"), envir = environment())
...
#Export everything needed
parallel::clusterExport(cl, c("meta_study", "sim_pop", "sim_meta", "study_designs_filtered"), 
                        envir = environment())
...
for (i in seq_along(study_map)) {
  ...
  requireNamespace(c("doParallel", "parallel"))
  #Set up cluster
  cl <- parallel::makeCluster(25) #Change based on # of cores in computer
  doParallel::registerDoParallel(cl)
  
  #Export everything needed
  parallel::clusterExport(cl, c("meta_study", "study_designs_filtered"), envir = environment())
  parallel::clusterEvalQ(cl, {
    library(tidyverse)
    library(DeclareDesign)
    library(hiddenmeta)
