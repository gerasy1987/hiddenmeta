---
title: "Diagnosing robustness of studies with hiddenmeta"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Diagnosing robustness of studies with hiddenmeta}
...
saveRDS(multi_designs_list, file = here::here("vignettes/study_designs_list.rds"))

```

```{r read_study_designs, eval=TRUE}

multi_designs_list <- readRDS(file = here::here("vignettes/study_designs_list.rds"))
...
for(i in seq_along(param_names)) {
  ...
  saveRDS(multi_simulations, file = here::here(paste0("vignettes/multi_sim_real_",
                                                      param_names[i], ".rds")))
