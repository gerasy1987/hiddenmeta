...
# multi_simulations <- simulate_design(multi_study, sims = 1)

# simulate multi-study design in parallel
...
meta_population <- 
  declare_population(multi_design = multi_study, n_sim = 7, parallel = TRUE, 
...
estimands <- draw_inquiry(meta_population + meta_inquiry)
data <- draw_data(meta_population + meta_inquiry + meta_sample)
