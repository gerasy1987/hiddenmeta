...
#Set up cluster
cl <- parallel::makeCluster(10) #Change based on # of cores in computer
doParallel::registerDoParallel(cl)

# Export everything needed
parallel::clusterExport(cl, c("study1"), envir = environment())
...
#Set up cluster
cl <- parallel::makeCluster(40) #Change based on # of cores in computer
doParallel::registerDoParallel(cl)

#Export everything needed
parallel::clusterExport(cl, c("multi_study"), envir = environment())
...
#Set up cluster
cl <- parallel::makeCluster(20) #Change based on # of cores in computer
doParallel::registerDoParallel(cl)

# Export everything needed
parallel::clusterExport(cl, c("meta_study"), envir = environment())
