...
set.seed(19872312)
( example_pops <- multi_populations() )
...
set.seed(19872312)
draw_data(multi_populations + multi_samples)
...
set.seed(19872312)
draw_estimands(multi_populations + multi_samples + multi_estimands)


# multi_estimators <- 
#   declare_estimator(handler = get_multi_estimators, multi_estimators) 
# 
# meta_switch <- 
#   declare_step(prep_multi_estimators, get_multi_estimators)
# 
# meta_estimands <- 
