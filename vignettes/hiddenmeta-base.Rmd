      ...
      list(
        ...
        network_handler_args = 
          list(N = 1000, K = 2, prev_K = c(known = .3, hidden = .1), rho_K = 0,
               p_edge_within = list(known = c(0.1, 0.1), hidden = c(0.1, 0.1)),
        ...
        add_groups = 
         ...
         "purrr::map_df(hidden, ~ sapply( `names<-`(c(0, 0, 0, 0), paste0('loc_', 1:4)), function(add) rbinom(length(.x), 1, 0.1 + .x * add)))",
