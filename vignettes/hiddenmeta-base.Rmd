...
diagnose_design(simulations_df = study_simulations, 
...
multi_estimands <- 
  declare_estimand(handler = get_multi_estimands, 
                   estimands_args = list(study_1 = study_1$estimands,
...
meta_design <- meta_population + meta_estimands + meta_estimators
