  ...
  list(
    pop = 
      list(
        ...
        add_groups = list(service_use = "rbinom(n(), 1, 0.1 + hidden * 0.2)",
                          loc_1 = "rbinom(n(), 1, 0.1 + hidden * 0.2)", 
                          loc_2 = 0.1, loc_3 = 0.2,
...
draw_estimates(study_population +
                 study_sample_rds + study_sample_pps + study_sample_tls +
                 study_estimands +
                 estimator_sspse + estimator_chords + estimator_ht + #estimator_nsum_tls + 
                 estimator_nsum)
```
