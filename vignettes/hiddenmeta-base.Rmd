...
example_pop %>%  head() %>% DT::datatable(options = list(dom = 'tp')) 
...
set.seed(19872312)
draw_data(study_population + study_sample_rds + study_sample_pps) %>% head() %>% 
  DT::datatable(options = list(dom = 'tp')) 
```
...
draw_data(study_population + 
            study_sample_rds + study_sample_pps + study_sample_tls) %>% head() %>% 
  DT::datatable(options = list(dom = 'tp')) 
```
