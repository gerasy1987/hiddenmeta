      ...
      list(
        ...
        network_handler_args = 
          list(N = 2000, K = 2, prev_K = c(known = .3, hidden = .1), rho_K = .05,
               p_edge_within = list(known = c(0.1, 0.1), hidden = c(0.1, 0.9)),
               p_edge_between = list(known = 0.1, hidden = 0.05),
               directed = FALSE),
      ...
      list(
        ...
        network_handler_args = 
          list(N = 5000, K = 3, 
               ...
               rho_K = c(.1, .1, .1),
               p_edge_within = list(frame = c(0.2, 0.2), 
                                    known = c(0.2, 0.2), 
                                    hidden = c(0.2, 0.9)),
               p_edge_between = list(frame = 0.2, 
                                     known = 0.2, 
                                     hidden = 0.05),
               directed = FALSE),
