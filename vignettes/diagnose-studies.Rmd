...
saveRDS(multi_designs_list_params, file = here::here("inst/extdata/study_designs_list_priors.rds"))
...
saveRDS(multi_designs_list_features, file = here::here("inst/extdata/study_designs_list_features.rds"))
