...
saveRDS(study_designs, file = here::here("vignettes/study_designs.rds"))

```

```{r read_study_designs, eval=TRUE}

study_designs <- readRDS(file = here::here("vignettes/study_designs.rds"))
...
saveRDS(multi_study_data, file = here::here("vignettes/multi_sim_data_draw.rds"))
...
saveRDS(multi_simulations, file = here::here("vignettes/multi_sim_real.rds"))

```

```{r multi_study_diagnose}

multi_simulations <- readRDS(here::here("vignettes/multi_sim_real.rds"))
...
multi_study_data <- readRDS(here::here("vignettes/multi_sim_data_draw.rds"))

get_required_data(multi_study_data)
