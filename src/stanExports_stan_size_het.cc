...
#include "stanExports_stan_size_het.h"

RCPP_MODULE(stan_fit4stan_size_het_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_stan_size_het")
