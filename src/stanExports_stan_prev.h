...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_stan_prev");
    reader.add_event(27, 25, "end", "model_stan_prev");
    return reader;
}
#include <stan_meta_header.hpp>
class model_stan_prev
  : public stan::model::model_base_crtp<model_stan_prev> {
private:
        int N;
        int K;
        int n_ests;
        ...
        vector_d ses;
public:
    model_stan_prev(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_stan_prev_namespace::model_stan_prev";
        ...
        try {
            ...
            validate_non_negative_index("bias_prior_mean", "K", K);
            context__.validate_dims("data initialization", "bias_prior_mean", "double", context__.to_vec(K));
            bias_prior_mean = std::vector<double>(K, double(0));
            vals_r__ = context__.vals_r("bias_prior_mean");
            pos__ = 0;
            size_t bias_prior_mean_k_0_max__ = K;
            for (size_t k_0__ = 0; k_0__ < bias_prior_mean_k_0_max__; ++k_0__) {
                bias_prior_mean[k_0__] = vals_r__[pos__++];
            }
            size_t bias_prior_mean_i_0_max__ = K;
            for (size_t i_0__ = 0; i_0__ < bias_prior_mean_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "bias_prior_mean[i_0__]", bias_prior_mean[i_0__], 0);
            }
            current_statement_begin__ = 8;
            validate_non_negative_index("bias_prior_sd", "K", K);
            context__.validate_dims("data initialization", "bias_prior_sd", "double", context__.to_vec(K));
            bias_prior_sd = std::vector<double>(K, double(0));
            vals_r__ = context__.vals_r("bias_prior_sd");
            pos__ = 0;
            size_t bias_prior_sd_k_0_max__ = K;
            for (size_t k_0__ = 0; k_0__ < bias_prior_sd_k_0_max__; ++k_0__) {
                bias_prior_sd[k_0__] = vals_r__[pos__++];
            }
            size_t bias_prior_sd_i_0_max__ = K;
            for (size_t i_0__ = 0; i_0__ < bias_prior_sd_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "bias_prior_sd[i_0__]", bias_prior_sd[i_0__], 0);
            }
            ...
            for (size_t i_0__ = 0; i_0__ < study_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "study[i_0__]", study[i_0__], 1);
            }
            ...
            for (size_t i_0__ = 0; i_0__ < design_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "design[i_0__]", design[i_0__], 1);
            }
            ...
            validate_non_negative_index("bias", "K", K);
            num_params_r__ += K;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("bias", "K", K);
        context__.validate_dims("parameter initialization", "bias", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> bias(K);
        size_t bias_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < bias_j_1_max__; ++j_1__) {
            bias(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0.01, bias);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                bias = in__.vector_lb_constrain(0.01, K, lp__);
            else
                bias = in__.vector_lb_constrain(0.01, K);
            current_statement_begin__ = 16;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> alpha;
            (void) alpha;  // dummy to suppress unused var warning
            if (jacobian__)
                alpha = in__.vector_lub_constrain(0, 1, N, lp__);
            else
                alpha = in__.vector_lub_constrain(0, 1, N);
            // model body
            current_statement_begin__ = 21;
            lp_accum__.add(normal_log(ests, elt_multiply(stan::model::rvalue(bias, stan::model::cons_list(stan::model::index_multi(design), stan::model::nil_index_list()), "bias"), stan::model::rvalue(alpha, stan::model::cons_list(stan::model::index_multi(study), stan::model::nil_index_list()), "alpha")), ses));
            current_statement_begin__ = 22;
            lp_accum__.add(normal_log<propto__>(alpha, alpha_prior_mean, alpha_prior_sd));
            current_statement_begin__ = 23;
            lp_accum__.add(lognormal_log<propto__>(bias, stan::math::log(bias_prior_mean), bias_prior_sd));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_stan_prev_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> bias = in__.vector_lb_constrain(0.01, K);
        size_t bias_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < bias_j_1_max__; ++j_1__) {
            vars__.push_back(bias(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha = in__.vector_lub_constrain(0, 1, N);
        size_t alpha_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < alpha_j_1_max__; ++j_1__) {
...
typedef model_stan_prev_namespace::model_stan_prev stan_model;
#ifndef USING_R
