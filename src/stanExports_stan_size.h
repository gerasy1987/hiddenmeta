...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_stan_size");
    reader.add_event(27, 25, "end", "model_stan_size");
    return reader;
}
#include <stan_meta_header.hpp>
class model_stan_size
  : public stan::model::model_base_crtp<model_stan_size> {
private:
        int N;
        int K;
        int n_ests;
        ...
        vector_d ses;
public:
    model_stan_size(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_stan_size_namespace::model_stan_size";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_stan_size_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_stan_size_namespace::model_stan_size stan_model;
#ifndef USING_R
