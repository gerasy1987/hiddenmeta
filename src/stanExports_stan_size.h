...
namespace model_stan_size_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 27> locations_array__ =
  {" (found before start of program)",
  " (in 'stan_size', line 15, column 2 to column 29)",
  " (in 'stan_size', line 16, column 2 to column 27)",
  " (in 'stan_size', line 19, column 2 to column 64)",
  " (in 'stan_size', line 20, column 2 to column 51)",
  " (in 'stan_size', line 21, column 2 to column 56)",
  " (in 'stan_size', line 2, column 2 to column 17)",
  " (in 'stan_size', line 3, column 2 to column 17)",
  " (in 'stan_size', line 4, column 2 to column 22)",
  " (in 'stan_size', line 5, column 33 to column 34)",
  " (in 'stan_size', line 5, column 2 to column 36)",
  " (in 'stan_size', line 6, column 31 to column 32)",
  " (in 'stan_size', line 6, column 2 to column 34)",
  " (in 'stan_size', line 7, column 32 to column 33)",
  " (in 'stan_size', line 7, column 2 to column 35)",
  " (in 'stan_size', line 8, column 30 to column 31)",
  " (in 'stan_size', line 8, column 2 to column 33)",
  " (in 'stan_size', line 9, column 21 to column 27)",
  " (in 'stan_size', line 9, column 2 to column 29)",
  " (in 'stan_size', line 10, column 22 to column 28)",
  " (in 'stan_size', line 10, column 2 to column 30)",
  " (in 'stan_size', line 11, column 18 to column 24)",
  " (in 'stan_size', line 11, column 2 to column 31)",
  " (in 'stan_size', line 12, column 18 to column 24)",
  " (in 'stan_size', line 12, column 2 to column 30)",
  " (in 'stan_size', line 15, column 21 to column 22)",
  " (in 'stan_size', line 16, column 18 to column 19)"};
#include <stan_meta_header.hpp>
class model_stan_size final : public model_base_crtp<model_stan_size> {
private:
  int N;
  int K;
  int n_ests;
...
public:
  ~model_stan_size() {}
  model_stan_size(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_stan_size_namespace::model_stan_size";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_stan_size_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_stan_size_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_stan_size_namespace::model_stan_size;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_stan_size_namespace::profiles__;
}
#endif
#endif
