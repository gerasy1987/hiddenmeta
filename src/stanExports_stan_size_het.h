...
static constexpr std::array<const char*, 40> locations_array__ =
  ...
  " (in 'stan_size_het', line 18, column 2 to column 19)",
  " (in 'stan_size_het', line 19, column 2 to column 19)",
  " (in 'stan_size_het', line 20, column 2 to column 27)",
  " (in 'stan_size_het', line 23, column 2 to column 34)",
  " (in 'stan_size_het', line 25, column 6 to column 88)",
  " (in 'stan_size_het', line 24, column 2 to line 25, column 88)",
  " (in 'stan_size_het', line 28, column 2 to column 58)",
  " (in 'stan_size_het', line 29, column 2 to column 51)",
  " (in 'stan_size_het', line 30, column 2 to column 54)",
  " (in 'stan_size_het', line 31, column 2 to column 54)",
  " (in 'stan_size_het', line 2, column 2 to column 17)",
  " (in 'stan_size_het', line 3, column 2 to column 17)",
  " (in 'stan_size_het', line 4, column 2 to column 22)",
  " (in 'stan_size_het', line 5, column 9 to column 10)",
  " (in 'stan_size_het', line 5, column 2 to column 22)",
  " (in 'stan_size_het', line 6, column 33 to column 34)",
  " (in 'stan_size_het', line 6, column 2 to column 36)",
  " (in 'stan_size_het', line 7, column 31 to column 32)",
  " (in 'stan_size_het', line 7, column 2 to column 34)",
  " (in 'stan_size_het', line 8, column 34 to column 35)",
  " (in 'stan_size_het', line 8, column 2 to column 37)",
  " (in 'stan_size_het', line 9, column 32 to column 33)",
  " (in 'stan_size_het', line 9, column 2 to column 35)",
  " (in 'stan_size_het', line 10, column 34 to column 35)",
  " (in 'stan_size_het', line 10, column 2 to column 37)",
  " (in 'stan_size_het', line 11, column 32 to column 33)",
  " (in 'stan_size_het', line 11, column 2 to column 35)",
  " (in 'stan_size_het', line 12, column 21 to column 27)",
  " (in 'stan_size_het', line 12, column 2 to column 29)",
  " (in 'stan_size_het', line 13, column 22 to column 28)",
  " (in 'stan_size_het', line 13, column 2 to column 30)",
  " (in 'stan_size_het', line 14, column 18 to column 24)",
  " (in 'stan_size_het', line 14, column 2 to column 31)",
  " (in 'stan_size_het', line 15, column 18 to column 24)",
  " (in 'stan_size_het', line 15, column 2 to column 30)",
  " (in 'stan_size_het', line 18, column 9 to column 10)",
  " (in 'stan_size_het', line 19, column 9 to column 10)",
  " (in 'stan_size_het', line 20, column 18 to column 19)",
  " (in 'stan_size_het', line 23, column 21 to column 27)"};
#include <stan_meta_header.hpp>
class model_stan_size_het final : public model_base_crtp<model_stan_size_het> {
private:
  int N;
  int K;
  int n_ests;
...
public:
  ~model_stan_size_het() {}
  model_stan_size_het(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_stan_size_het_namespace::model_stan_size_het";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_stan_size_het_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_stan_size_het_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_stan_size_het_namespace::model_stan_size_het;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_stan_size_het_namespace::profiles__;
}
#endif
#endif
